            ...
            user ? ( <
                ...
                ul > {
                    searchResults.map((movieId) => ( <
                        ...
                        <
                        img src = { favResults[movieId].Poster }
                        ...
                        variant = "contained" > { movieReviews[favResults[movieId].imdbID] ? 'Edit Review' : 'Add Review' } <
                        /Button> <
                        /Link> <
                        Button sx = {
                            {
                        ...
                        variant = "contained"
                        onClick = {
                            () => addToFavorites(favResults[movieId]) } >
                        {
                        ...
                        variant = "contained"
                        onClick = {
                            () => addToWatchlist(favResults[movieId]) } >
                        {
                ...
                ul > {
                    Object.values(favResults).map((movie) => ( <
                        ...
                        variant = "contained" > { movieReviews[movie.imdbID] ? 'Edit Review' : 'Add Review' } <
                        /Button> <
                        /Link> <
                        Button sx = {
                            {
