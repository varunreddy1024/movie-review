            ...
            user ? ( <
                ...
                className = 'movies-list-main' > {
                    showForm ? ( <
                        ...
                        /> <
                        input style = {
                            { margin: '20px', height: '56px' } }
                        type = "date"
                        value = { customDate }
                        onChange = {
                            (e) => setCustomDate(e.target.value) }
                        /> <
                        /div> <
                        div >
                        <
                ...
                ul > {
                    dairyEntries.map((entry) => ( <
                        ...
                        size = "medium"
                        onClick = {
                            () => handleEditEntry(entry.id) } > Edit < /Button> <
                        Button sx = {
                            { m: 1 } }
                        variant = "outlined"
                        startIcon = { < DeleteIcon / > }
                        onClick = {
                            () => handleDeleteEntry(entry.id) } > Delete < /Button> <
                        /li> <
                        /div>
                    ))
                }
